...
def main():
    ...
    parser.add_argument("--output_dir",type=Path, default=Path('/mnt/cvda/cvda_phava/code/Han/PhyAvatar/ActorsHQ-for-Gaussian-Garments/gs2mesh/data/custom/Actor01_Sequence1/txt'))
