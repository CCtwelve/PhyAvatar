...
# 目标路径
target_path = "/mnt/cvda/cvda_phava/code/Han/3DGS/colmap/data/multipleview/0_17"  # 请替换为你的目标路径
number = '0000'
# 确保目标路径存在
os.makedirs(target_path, exist_ok=True)
cam_list = [23, 38, 39, 54, 56, 77, 79, 93, 95, 110, 126, 127, 128, 135, 152, 159, 160]
# 遍历160个摄像机文件夹
